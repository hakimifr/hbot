...
You probably want to read the documentations `here`_ instead.

To build the documentations, you need to have ``make`` installed. Simply run

.. code-block:: sh

   make html

The Makefile was generated by sphinx. The built page live on ``build/html`` directory.

.. _here: https://hakimifr.github.io/hbot
